...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct item_sig, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct item_sig, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct item_sig),
	offsetof(struct item_sig, _asn_ctx),
	offsetof(struct item_sig, present),
	sizeof(((struct item_sig *)0)->present),
...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GenericSignage__Member, item_sig),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
