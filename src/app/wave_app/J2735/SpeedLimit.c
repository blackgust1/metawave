...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct item_speed, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct item_speed, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct item_speed),
	offsetof(struct item_speed, _asn_ctx),
	offsetof(struct item_speed, present),
	sizeof(((struct item_speed *)0)->present),
...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SpeedLimit__Member, item_speed),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
