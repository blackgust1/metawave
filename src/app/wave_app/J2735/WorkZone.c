...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct item_work, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct item_work, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct item_work),
	offsetof(struct item_work, _asn_ctx),
	offsetof(struct item_work, present),
	sizeof(((struct item_work *)0)->present),
...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WorkZone__Member, item_work),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
