...
#else
extern mr_unsign32 aes_encrypt_ecies(aes *,char *);
#endif

#if 0	//SHKO, Origin
extern mr_unsign32 aes_decrypt(aes *,char *);
#else
extern mr_unsign32 aes_decrypt_ecies(aes *,char *);
#endif
...
extern void ecn2_precomp_gls(_MIPT_ int,ecn2 *,zzn2 *,ecn2 *);
extern int ecn2_mul2_gls(_MIPT_ big *,ecn2 *,zzn2 *,ecn2 *);
extern void ecn2_precomp(_MIPT_ int ,ecn2 *,ecn2 *);
